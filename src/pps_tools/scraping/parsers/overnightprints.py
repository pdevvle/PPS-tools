"""Overnight Prints pricing parser."""
...
logger = logging.getLogger("pps_tools.scraping.parsers.overnightprints")


class OvernightPrintsParser(BaseParser):
    competitor_name = "overnightprints"

    def can_parse(self, url: str, html: str) -> bool:
        return "overnightprints.com" in url.lower()
    ...
    def parse(self, url: str, html: str, product: str) -> list[PricePoint]:
        ...
        # Strategy 4: Starting/from prices
        text = soup.get_text()
        ...
        logger.info("OvernightPrints parser found %d price points for %s", len(points), product)
        return points
